...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=ROOT / "models/tiredata_yolov5.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "data/tiredata.yaml", help="dataset.yaml path")
...
#python train.py --data tiredata.yaml --cfg tiredata_yolov5.yaml --weights pretrained/yolov5s.pt --epoch 100 --batch-size 4 --device=0
